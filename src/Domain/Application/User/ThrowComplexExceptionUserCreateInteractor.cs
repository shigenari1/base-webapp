...
namespace src.Domain.Application.User
{
    ...
    /// テスト用ユーザ登録処理の実装
    /// </summary>
    public class ThrowComplexExceptionUserCreateInteractor : IUserCreateUseCase
    {
        public static int id;
        private readonly IUserCreatePresenter presenter;
        
        public ThrowComplexExceptionUserCreateInteractor(IUserRepository userRepository, IUserCreatePresenter presenter)
        {
